...
OVERRIDES_DEFAULT = str(TOOL_ROOT / "configs" / "qwen35-q4s8-v1-overrides.txt")
...
def main() -> int:
    ...
    ap.add_argument("--model", required=True, help="BF16 Qwen3.6-35B-A3B GGUF with embedded MTP")
